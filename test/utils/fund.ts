 ...
 */
export const funder = mnemonicToSecretKey("adapt mule code swamp target refuse inspire violin winner fashion reopen evoke crouch work swim segment subway hybrid donate orbit guess govern cost abstract vault");

/**
 * Main account that can be used as an algo dispenser
 */
export async function fundAccountWithAlgo(algodClient: Algodv2, addr: string, amount: number | bigint, params?: SuggestedParams): Promise<string> {
